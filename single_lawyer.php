			...
			<div class="row">
				<div class="col-md-12">
					<nav class="navbar navbar-expand-lg ">
						<img src="photos\ashok.jpg" width="90" height="90">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav ml-auto ">
								...
								<li class="">
									<a class="nav-link cus-a"
										href="single_lawyer.php">Lawyers</a><!--lawyers.html page-->
								</li>
								<li class="">
				...
				while ($row = mysqli_fetch_array($result)) {
					...
					<div class="col-md-3">
						<div class="sideprofile">
							<img src="images/upload/<?php echo $row["image"]; ?>" class="img-fluid profile_img"
								alt="profile picture">
							<h2>
					...
					<div class="col-md-9">
						<div class="mainprofile">
							...
							<div class="infogroup row">
								...
								<div class="col-md-8">
									<p>
										<?php echo $row["university_College"]; ?>
									</p>
									<p>
										<?php echo $row["degree"]; ?>
									</p>
							...
							<form action="save_booking.php" method="post">
								<div class="row">
									...
									<input type="hidden" name="client_id"
										value="<?php echo isset($_SESSION['client_id']) ? $_SESSION['client_id'] : ''; ?>">
									...
									<div class="col-md-3">
										<textarea name="description" id="" cols="20" rows="4"
											placeholder="write description if any"></textarea>
									</div>
									<div class="col-md-3 float-right">
										<?php if (isset($_SESSION['login']) && $_SESSION['login'] == TRUE) { ?>
											<input name="post" type="submit" class="btn btn-block btn-info"
												value="Request booking" />
										<?php } else { ?>
											<h6><a href="login.php">To Request for lawyer booking please login or register
													first</a></h6>
										<?php } ?>
									</div>
								</div>
