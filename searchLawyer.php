								...
								<ul class="navbar-nav ml-auto ">
									...
									<?php } else { ?>
										...
										<li class="nav-item dropdown">
											<a class="nav-link dropdown-toggle cus-a" href="#" id="navbarDropdown"
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<select name="location" class="form-control">
								...
								<option value="Chittagong">Pune</option>
								<option value="Kolkata">Kolkata</option>
								<option value="Chalisgaon">Chalisgaon</option>
								<option value="Mumbai">Mumbai</option>
								<option value="Bhusawal">Bhusawal</option>
								<option value="Delhi">Delhi</option>
								<option value="Shinagar">Shinagar</option>
							</select>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-md-4">
							<button id="button" type="submit" class="btn btn-mg btn-primary" name="submit"
								value="submit" style="float:right"><i class="fa fa-search"></i>&nbsp; Search
								Information</button>
						</div>
					</div>
				</form>
								...
								<div class="card" style="width: 18rem;">
									...
									<div class="card-body">
										...
										<a class="btn btn-sm btn-info"
											href="single_lawyer.php?u_id=<?php echo $row["u_id"]; ?>"><i
