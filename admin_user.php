							...
							<div class="container">
								<div class="collapse navbar-collapse" id="navbarSupportedContent">
									<ul class="navbar-nav ml-auto ">
										<li class="active">
											<a class="nav-link cus-a" href="#">Home <span
			...
			<div class="d-flex" id="wrapper">
				...
				<div class="bg-light border-right" id="sidebar-wrapper">
					...
					<div class="list-group list-group-flush">
						...
						<a href="admin_lawyer.php" class="list-group-item list-group-item-action bg-light">See
							lawyers</a><!--admin_lawyer page-->
						<a href="admin_user.php" class="list-group-item list-group-item-action bg-light">See
							Users</a><!--admin_user page-->
					</div>
				</div>
				<!-- /#sidebar-wrapper -->
										...
										while ($row = mysqli_fetch_array($result)) {
											...
											<tbody id="myTable">
												<tr>
													...
													<td><img src="images/upload/<?php echo $row["image"]; ?>" class="img-fluid "
															alt="<?php echo $row["image"]; ?>"></td>
													<?php if ($row['status'] == 'Active') { ?>
														<td>
															<a class="btn btn-sm btn-danger"
																href="admin_user.php?block_id=<?= $row['u_id'] ?>"><i
																	class="fa fa-ban"></i>&nbsp; Block</a>
														</td>
													<?php } else { ?>
														<td>
															<a class="btn btn-sm btn-warning"
																href="admin_user.php?unblock_id=<?= $row['u_id'] ?>"><i
