						...
						<nav class="navbar navbar-expand-lg ">
							...
							<div class="container">
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent">
									...
									<li class="">
											<a class="nav-link cus-a" href="lawyers.php">Lawyer Inquiry
								...
								<div class="form-row">
									...
									<div class="form-group col-md-3">
										...
										<select id="city" name="city" class="form-control">
											...
											<option value="Chittagong" <?php if ($row['city'] == 'Chittagong') {
												echo "selected";
											} ?>>Chittagong</option>
											<option value="Sylhet" <?php if ($row['city'] == 'Sylhet') {
												echo "selected";
											} ?>>Sylhet
											</option>
											<option value="Barishal" <?php if ($row['city'] == 'Barishal') {
												echo "selected";
											} ?>>
												Barishal</option>
