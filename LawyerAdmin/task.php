		...
		<div id="page-wrapper">
			...
			<div class="existing-records">
				<div style="text-align: right; margin-bottom: 10px;">
					...
					<a href="addtask.php" class="btn btn-primary pull-right">Add Task</a>
				</div>
				<h2>Task Records</h2>
				...
				<table>
					...
					<tbody>
						...
						// Perform SQL query to fetch case records
						$query = "SELECT task_subject, end_date, status1, priority, task_description FROM task";
						...
						if ($records) {
							foreach ($records as $record) {
								...
								echo "<td>" . (isset($record['task_subject']) ? $record['task_subject'] : '') ."</td>";
								// Assuming you have a column named 'client_number' in your database
								// Assuming you have a column named 'mobile' in your database
								echo "<td>" . (isset($record['end_date']) ? $record['end_date'] : '') . "</td>";
								echo "<td>" . (isset($record['status1']) ? $record['status1'] : '') . "</td>";
                                echo "<td>" . (isset($record['priority']) ? $record['priority'] : '') . "</td>";
                                echo "<td>" . (isset($record['task_description']) ? $record['task_description'] : '') . "</td>";
								echo "</tr>";
							}
						} else {
